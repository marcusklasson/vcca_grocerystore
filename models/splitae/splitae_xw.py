...
class SplitAE(object):
    ...
    def __init__(self, dim_x, dim_z, dim_w, word_to_idx, lambda_x=1.0, lambda_w=1.0,
        ...
        """ SplitAutoencoder for image features and text descriptions.
        ...
        self.build_graph()
        print("SplitAE_xw is initialized.")
    ...
    def build_graph(self):
        ...
        ### Loss   
        self.loss = -tf.reduce_mean(self.x_rec_loss + self.caption_rec_loss)
        ...
        self.log_var = [self.loss, self.x_rec_loss, self.caption_rec_loss]
