...
class SplitAE(object):
    ...
    def __init__(self, dim_x, dim_z, dim_i, dim_w, word_to_idx,
        ...
        """ SplitAutoencoder for image features, iconic images, and text descriptions.
        ...
        self.build_graph()
        print("SplitAE_xiw is initialized.")
    ...
    def build_graph(self):
        ...
        ### Total loss
        self.loss = -tf.reduce_mean(self.x_rec_loss + self.i_rec_loss + self.caption_rec_loss)
...
def run_training_epoch(args, data, model, hyperparams, session, train_op=None, shuffle=False, mode='train'):
    ...
    for i in range(n_batches):
        ...
        feed_dict={model.x: x_batch, model.iconic_images: i_batch, model.captions: captions_batch,
