...
class SplitAE(object):
    ...
    def __init__(self, dim_x, dim_z, dim_labels, dim_i, dim_w, word_to_idx,
        ...
        """ SplitAutoencoder for image features, iconic images, text descriptions, and labels.
        ...
        self.build_graph()
        print("SplitAE_xiwy is initialized.")
    ...
    def build_graph(self):
        ...
        ### Total loss  
        self.loss = -tf.reduce_mean(self.x_rec_loss + self.i_rec_loss + self.caption_rec_loss + self.clf_loss)

        ### Used in training feed_dict
        self.log_var = [self.loss, self.x_rec_loss, self.i_rec_loss, self.caption_rec_loss,
