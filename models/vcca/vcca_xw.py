...
class VCCA(object):
    ...
    def __init__(self, dim_x, dim_z, dim_w, word_to_idx, lambda_x=1.0, lambda_w=1.0,
        ...
        """ VCCA for image features and text descriptions.
    ...
    def build_graph(self):
        ...
        self.loss = -tf.reduce_mean(self.kl_div + self.x_rec_loss + self.caption_rec_loss)
        ...
        self.log_var = [self.loss, self.kl_div, self.x_rec_loss, self.caption_rec_loss]
